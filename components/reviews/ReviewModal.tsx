...
const ReviewModal: React.FC<ReviewModalProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    if (!clientId) {
      showError('Você precisa estar autenticado para avaliar');
      return;
    }
    ...
    try {
      ...
      showError('Não foi possível enviar a avaliação. Tente novamente.');
    } finally {
              ...
              >
                ...
                <View style={styles.header}>
                  ...
                  <TouchableOpacity onPress={onClose} style={styles.closeButton}>
                    <Icon name="close" family="MaterialSymbols" size={24} color={colors.textPrimary} />
                  </TouchableOpacity>
                </View>
